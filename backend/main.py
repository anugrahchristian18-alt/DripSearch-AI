...
def display_cloth_analysis(cloth_data):
    ...
    print(
        "Clothing Type:",
        cloth_data.get("clothing_type")
    )

    print(
        "Color:",
        cloth_data.get("color")
    )

    print(
        "Pattern:",
        cloth_data.get("pattern")
    )

    print(
        "Style:",
        cloth_data.get("style")
    )

    print(
        "Gender:",
        cloth_data.get("gender")
    )
...
def main():
    ...
    if not cloth_data:
        ...
        print(
            "Could not analyze cloth image."
        )

        return

    display_cloth_analysis(
        cloth_data
    )
